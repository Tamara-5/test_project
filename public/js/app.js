...
for (var i = 0; i < deleteClientButtons.length; i++) {
  deleteClientButtons[i].addEventListener("click", function () {
    var thiz = this;
    axios["delete"]('/client/' + this.getAttribute('data-id')).then(function (response) {
...
headerItems.forEach(function (headerItem) {
  headerItem.addEventListener('click', function () {
    var tabId = headerItem.getAttribute('data-tab');
    ...
    var selectedTab = document.querySelector("#".concat(tabId));
